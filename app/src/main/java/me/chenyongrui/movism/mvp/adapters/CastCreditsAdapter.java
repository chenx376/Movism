...
public class CastCreditsAdapter extends RecyclerView.Adapter<CastCreditsAdapter.ViewHolder> {
    private Context context;
    private List<CastMovieCredits> movieList;
    ...
    public CastCreditsAdapter(Context context, List<CastMovieCredits> movieList) {
    ...
    public void onBindViewHolder(ViewHolder viewHolder, int position) {
        final CastMovieCredits movie = movieList.get(position);
    ...
    public interface MovieClickListener {
        void onMovieClicked(CastMovieCredits movie);
    }
